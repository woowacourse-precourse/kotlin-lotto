...
class LottoCheckTest {
    ...
    fun `로또 번호가 당첨 번호와 6개 일치한다`() {
        ...
        Assertions.assertThat(lottoReward).isEqualTo(LottoReward.FIRST)
    }
    ...
    fun `로또 번호가 당첨 번호와 5개와 보너스 번호가 일치한다`() {
        ...
        Assertions.assertThat(lottoReward).isEqualTo(LottoReward.SECOND)
    }
    ...
    fun `로또 번호가 당첨 번호와 5개 일치하고 보너스 번호가 일치하지 않는다`() {
        ...
        Assertions.assertThat(lottoReward).isEqualTo(LottoReward.THIRD)
    }
    ...
    fun `로또 번호가 당첨 번호와 4개 일치한다`() {
        ...
        Assertions.assertThat(lottoReward).isEqualTo(LottoReward.FOURTH)
    }
    ...
    fun `로또 번호가 당첨 번호와 3개 일치한다`() {
        ...
        Assertions.assertThat(lottoReward).isEqualTo(LottoReward.FIFTH)
    }
    ...
    fun `로또 번호가 당첨 번호와 2개 일치한다`() {
        ...
        Assertions.assertThat(lottoReward).isEqualTo(LottoReward.NOTHING)
    }
