...
class ConsoleMessage {
    enum class Message(val sentence: String) {
        ...
        SAME_3_NUMBER("3개 일치 (5,000원) - "),
        SAME_4_NUMBER("4개 일치 (50,000원) - "),
        SAME_5_NUMBER("5개 일치 (1,500,000원) - "),
        SAME_5_NUMBER_AND_BONUS_NUMBER("5개 일치, 보너스 볼 일치 (30,000,000원) - "),
        SAME_6_NUMBER("6개 일치 (2,000,000,000원) - "),
    ...
    fun winningResult(prizeResult: ArrayList<Int>) {
        ...
        println("${Message.SAME_3_NUMBER.sentence}${prizeResult[0]}${Message.AMOUNT.sentence}")
        println("${Message.SAME_4_NUMBER.sentence}${prizeResult[1]}${Message.AMOUNT.sentence}")
        println("${Message.SAME_5_NUMBER.sentence}${prizeResult[2]}${Message.AMOUNT.sentence}")
        println("${Message.SAME_5_NUMBER_AND_BONUS_NUMBER.sentence}${prizeResult[3]}${Message.AMOUNT.sentence}")
        println("${Message.SAME_6_NUMBER.sentence}${prizeResult[4]}${Message.AMOUNT.sentence}")
    }
