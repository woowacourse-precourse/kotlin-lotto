...
class BonusNumber(private val bonusNumber: String, private val winningNumbers: Lotto) {
    init {
        checkBonusNumberThrowException()
    }

    private fun checkBonusNumberThrowException() {
