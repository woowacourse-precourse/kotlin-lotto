...
object Constants {
    ...
    val ERROR_LOTTO_NUMBER_DUPLICATED_NUMBER = "[ERROR] 로또 번호는 서로 중복되지 않은 숫자여야 합니다."
    val ERROR_LOTTO_NUMBER_OVER_SIX_NUMBER = "[ERROR] 로또 번호는 6개의 숫자여야 합니다."
    val ERROR_LOTTO_NUMBER_NOT_BETWEEN_ONE_AND_FORTYFIVE = "[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다."

    val ERROR_BONUS_NUMBER_DUPLICATED_IN_LOTTO_NUMBERS = "[ERROR] 보너스 번호는 입력했던 6개의 숫자와 중복되지 않아야 합니다."
    val ERROR_BONUS_NUMBER_NOT_BETWEEN_ONE_AND_FORTYFIVE = "[ERROR] 보너스 번호는 1부터 45 사이의 숫자여야 합니다."

    val ERROR_PURCHASE_MONEY_NOT_THOUSAND_UNIT = "[ERROR] 구입 금액은 1000원 단위여야 합니다."
}