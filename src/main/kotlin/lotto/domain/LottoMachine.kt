...
class LottoMachine (cost: Int) {
    ...
    fun generate(): List<Lotto> {
        ...
        repeat(ticketCount) {
            ...
            lottoTickets.add(lottoTicket.sort())
        }
    ...
    companion object {
        const val COST_RANGE_EXCEPTION = "[ERROR] 구매 불가능한 금액입니다. 1000원 이상부터 구매 가능합니다."
        const val COST_UNIT_EXCEPTION = "[ERROR] 구매 불가능한 금액입니다. 1000원 단위로 구매 가능합니다."
