...
const val BONUS_INPUT_MSG = "\n보너스 번호를 입력해주세요."

const val DIVISION_EXCEPTION_MSG = "[ERROR] 1000원 단위의 금액만 입력해주세요."
const val RANGE_BOUNDS_EXCEPTION_MSG = "[ERROR] 1부터 45 사이의 숫자만 입력해주세요."
const val DUPLICATE_EXCEPTION_MSG = "[ERROR] 중복되지 않는 숫자를 입력해주세요."
const val SIZE_BOUNDS_EXCEPTION_MGS = "[ERROR] 당첨 번호는 6개여야 합니다."

const val WINNER_RESULT_MGS = "\n당첨 통계\n---"
const val WINNER_5_MSG = "3개 일치 (5,000원)"
const val WINNER_4_MSG = "4개 일치 (50,000원)"
const val WINNER_3_MSG = "5개 일치 (1,500,000원)"
...
const val LOTTO_NUM_LIMIT = 6

const val ROUND_CRITERIA = 2
