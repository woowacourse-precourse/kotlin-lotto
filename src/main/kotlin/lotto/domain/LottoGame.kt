...
class LottoGame(
    ...
    fun play(): Pair<List<Int>, Double> {
        ...
        val winningDetails = getWinningDetails(winningResult)
        return winningDetails to earningRate
    }

    private fun getWinningDetails(winningResult: Map<WinningRank, Int>): List<Int> {
