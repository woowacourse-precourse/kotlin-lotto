...
class WinningStatistics {
    ...
    fun winningStatistics(listOfLotto: Set<List<Int>>,correctLotto:List<Int>, bonus:Int): Int{
    ...
    // 로또 일치 통계
    private fun winningMap(arr:List<Pair<Int,Boolean>>): Map<String, Int>{
    ...
    // 총 수익
    private fun incomeCalculation(arr:List<Pair<Int,Boolean>>):Int{
        var yield = 0
        for (j in arr){
