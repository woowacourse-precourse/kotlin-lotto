...
- [x] 쉼표 기준으로 1~45 사이 6개의 중복되지 않은 당첨 번호 입력 받기
- [x] 1~45 사이의 보너스 번호 1개 입력 받기
- [x] 당첨 번호, 보너스 번호와 구매한 로또 번호를 비교하여 당첨된 숫자 구하기
- [x] 당첨 번호, 보너스 번호와 구매한 로또 번호를 비교하여 당첨 통계 출력
  - 3개 일치 (5,000원)
  - 4개 일치 (50,000원)
  - 5개 일치 (1,500,000원)
  - 5개 일치, 보너스 볼 일치 (30,000,000원)
  - 6개 일치 (2,000,000,000원)
- [x] 총 수익률을 소수점 둘째 자리에서 반올림하여 출력
- [x] 예외 처리
