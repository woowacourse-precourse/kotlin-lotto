...
- 로또 구입 금액을 입력 받는다
  - 금액에 따른 로또 수량 출력
  - exception: 1000원으로 나누어 떨어지지않는 경우
  - exception: 숫자를 입력하지 않은 경우
  - exception: 0을 입력했을 경우

- 당첨 번호를 입력받는다
  - 쉼표를 기준으로 구분한다
  - exception: 번호가 6개가 아닌 경우

- 보너스 번호를 입력 받는다

- 당첨 번호와 보너스 번호 입력받을 때 예외
  - exception: 번호들이 중복되는 경우
  - exception: (1~45) 범위 안에 안들어가는 경우
  - exception: 숫자가 아닌 경우
